...
namespace StardewCapital.Services.Market
{
    ...
    public class IntradayNewsImpactService
    {
        ...
        public IntradayNewsImpactService(IMonitor monitor)
        {
            _monitor = monitor;
        }
        ...
        public void ApplyNewsShockToAll(NewsEvent news, System.Collections.Generic.List<CommodityFutures> allFutures, double impactSensitivity = 0.01)
        {
